...
namespace projeto_passagens_aerea
{
    class Program
    {
        //Criar uma aplicação para uma agência de turismo, no qual deveremos registrar passagens aéreas com os 
        //Seguintes dados: Nome do passageiro, Origem, Destino e Data do Voo de 5 passageiros.
        // Função Console.Clear(); tem como objetivo limpar a tela antes da execução para exibir apenas o algoritmo executado.
